  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      await login({
        ...
        cf_turnstile_token: isElectron() ? undefined : turnstileToken,
      });
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white shadow-lg rounded-lg p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          {/* Cloudflare Turnstile 验证 - 仅在非Electron环境中显示 */}
          {!isElectron() && (
            <div>
          ...
          <button
            type="submit"
            disabled={isSubmittingForm || loading || (!isElectron() && !turnstileToken)}
